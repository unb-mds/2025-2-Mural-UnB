      ...
      <article className="detail-content">
        <header className="detail-header">
          <div className="detail-logo">
            <img src={opportunity.logo || "/placeholder.svg"} alt={opportunity.name} />
          </div>
        ...
        {opportunity.coverImage && (
          <div className="detail-cover">
            <img src={opportunity.coverImage || "/placeholder.svg"} alt={`${opportunity.name} cover`} />
          </div>
        )}
        ...
        {opportunity.social && (
          <footer className="detail-footer">
            {opportunity.social.website && (
              <a href={opportunity.social.website} target="_blank" rel="noopener noreferrer" className="apply-button">
                Visitar Site
              </a>
            )}
