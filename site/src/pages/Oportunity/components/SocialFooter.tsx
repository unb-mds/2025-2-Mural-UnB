...
const SocialFooter = ({ website, instagram }: SocialFooterProps) => {
    ...
    <footer className="flex gap-4 mt-8 pt-8 border-t border-[#e5e5e5] justify-center max-md:flex-col">
      ...
      {instagram && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center py-3 px-3 bg-white text-[#1a7f4e] no-underline rounded-lg font-semibold transition-all border-2 border-[#1a7f4e] cursor-pointer text-base min-w-[44px] min-h-[44px] hover:bg-[#f0f9f4] max-md:w-full max-md:px-8"
